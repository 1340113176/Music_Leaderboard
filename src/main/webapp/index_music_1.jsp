...
<head>
    ...
    <style>
		...
		#kugou_table,#qq_table,#jiuku_table,#yiting_table{
			margin-top:10px;
			overflow:auto;
            height:550px;           
		}
...
<body>
    ...
    <div class="ui grid" id="zong">
        <!--5宽度列:酷狗or九酷-->
        <div class="five wide column" id="kugou_jiuku">
        ...
        <!--3宽度列:酷我-->
        <div class="four wide column" id="kuwo">	        
        ...
        <!--3宽度列:QQ音乐or一听-->        
        <div class="five wide column" id="QQ_yiting">
